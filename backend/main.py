...
_CUSTOMERS = [
    "김태희","이준혁","박서연","최민준","정유진","한지민","오세훈","임나연","강동원","신민아",
    "유재석","이효리","장나라","현빈","손예진","공유","전지현","이병헌","김혜수","고수",
    "차은우","아이유","박보검","수지","송혜교","조인성","하지원","김우빈","박신혜","이민호",
    "류준열","김고은","변요한","천우희","정해인","박소담","위하준","전여빈","오정세","김선영"
]
_SALE_MEMOS = [
...
def seed_data():
    ...
    while cur_day <= today:
        ...
        for _ in range(random.randint(0, 10)):
            ...
            total = random.randint(10, 300) * 10000
            ptype = random.choices(['card','cash','credit'], weights=[60,30,10])[0]
